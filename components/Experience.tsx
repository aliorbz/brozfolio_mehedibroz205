...
const experiences = [
  {
    company: 'DISCORD',
    role: 'Top role holder at several DC servers',
    years: '',
  ...
  },
  {
    ...
    years: '',
    icon: 'https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/globe.svg'
  }
];
  ...
  return (
    <section className="py-8 sm:py-12 scroll-reveal">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        <div className="lg:col-span-5 bento-card p-10 sm:p-14 lg:p-16 flex flex-col justify-between !bg-[#d9f5fc]">
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          {experiences.map((exp, idx) => (
            <div key={idx} className="bento-card p-7 sm:p-9 flex items-center gap-6 group transition-all flex-1 !bg-[#d9f5fc]">
              <div className="w-16 h-16 rounded-full overflow-hidden bg-black/5 flex-shrink-0 flex items-center justify-center p-3.5 border border-black/5 group-hover:bg-black/10 transition-all shadow-sm">
                <img 
                  src={exp.icon} 
                  alt={exp.company} 
