...
const projects: Project[] = [
  {
    id: 1,
    title: 'Kite AI Ambassador',
    year: '',
    tags: [
      { name: 'Ambassador', color: 'bg-[#EAF8F8] text-[#42B1B1]' }
      
    ],
    image: 'https://i.ibb.co.com/SX4GSk4z/Untitled-design-20260405-144516-0000.webp',
    fullWidth: true
  },
  {
    id: 2,
    title: 'Storacha Ambassador',
    year: '',
    tags: [
      { name: 'Ambassador', color: 'bg-[#EAF8F8] text-[#42B1B1]' }
    ...
    image: 'https://i.ibb.co.com/b5YXcZzr/Screenshot-20260405-142317-Discord.webp'
  },
  {
    id: 3,
    title: 'PrismaX Stabilized',
    year: '',
    tags: [
      { name: 'DC ROLE', color: 'bg-[#EAF8F8] text-[#42B1B1]' }
      
    ],
    image: 'https://i.ibb.co.com/Yr8DW4Z/Untitled-design-20260405-144731-0000.webp'
  }
];

const SelectedWork: React.FC = () => {
  return (
    <section className="scroll-reveal bg-[#d9f5fc] rounded-[2.5rem] sm:rounded-[3.5rem] p-6 sm:p-12 lg:px-16 lg:py-20 overflow-visible shadow-sm">
