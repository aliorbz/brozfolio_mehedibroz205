...
const Hero: React.FC = () => {
  const socialIcons = [
    { name: 'x', domain: 'x.com', url: 'https://x.com/luffyzorousof20' },
    { name: 'linkedin', domain: 'linkedin.com', url: 'https://www.linkedin.com/in/mehedi-broz-67b768378/' },
    { name: 'telegram', domain: 't.me', url: 'https://t.me/Mehedi206' },
    { name: 'discord', domain: 'discord.com', url: 'https://discord.com/users/1166990152313344062' },
    { name: 'facebook', domain: 'facebook.com', url: 'https://www.facebook.com/md.mehedi.al.mamun.2024' },
    { name: 'github', domain: 'github.com', url: 'https://github.com/Mehedialmamun' }
  ];

  return (
    <section className="grid grid-cols-1 lg:grid-cols-12 gap-4 scroll-reveal">
      {/* Left Text Part */}
      <div className="lg:col-span-7 bento-card p-6 sm:p-10 lg:p-16 flex flex-col justify-center min-h-[400px] sm:min-h-[500px] !bg-[#d9f5fc]">
        ...
        <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black text-[#1a1a1a] leading-[1.1] sm:leading-[0.9] tracking-tighter mb-6 sm:mb-8">
          Hi, I'm Mehedi<span className="text-2xl sm:text-4xl align-top ml-1">©</span>
        </h1>
        <p className="text-black text-base sm:text-xl max-w-md mb-8 leading-relaxed font-medium">
          Web3 community Ambassador with experience managing secure, well organized crypto communities, building trust, encouraging engagement and maintaining a positive structured environment.
        </p>
        <a 
          href="https://discord.com/users/1166990152313344062" 
          target="_blank"
      ...
      <div className="lg:col-span-5 grid grid-cols-1 gap-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="bento-card p-4 sm:p-6 flex flex-col justify-between overflow-hidden relative min-h-[180px] !bg-[#d9f5fc]">
             ...
             <img 
               src="https://i.ibb.co.com/GvCCyyJN/1775397036623.webp" 
             ...
             <div className="mt-auto z-10 pt-4">
                <div className="bg-gray-100 p-1.5 rounded-lg text-[8px] sm:text-[10px] font-bold inline-flex items-center gap-1 w-fit text-black">
                    <span>⚡ EXPERT</span>
                </div>
             </div>
          </div>
          <div className="bento-card overflow-hidden min-h-[180px]">
             {/* Profile Picture */}
             <img 
               src="https://i.ibb.co.com/yFjGQQSv/20260405-132806.webp" 
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-[#ff4e46] rounded-[1.5rem] sm:rounded-[2rem] p-4 sm:p-6 text-black flex flex-col justify-between min-h-[160px] relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-base sm:text-xl lg:text-2xl font-black uppercase tracking-[0.25em] mb-2 sm:mb-4">FAM</p>
            </div>
          ...
          <div className="bento-card p-3 sm:p-6 grid grid-cols-3 gap-2 sm:gap-3 place-items-center !bg-[#d9f5fc]">
